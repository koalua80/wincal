var cal = {
  ...
  sMon : true, // Week start on Monday/Sunday
...
// INIT - DRAW MONTH & YEAR SELECTOR
  ...
  // Set to 5 years range. Change this as you like.
...
document.getElementById("btn-next").addEventListener("click", function(){
  for (var opt, j=0; opt=opts[j]; j++){  
    ...
    if(opt.value==cal.sMth) {
      month.selectedIndex = j+1;
      cal.sMth++
      break;
    }
  }
